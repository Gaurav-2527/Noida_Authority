...
namespace Noida.Authority.DAL.EF
{
    ...
    public partial class ViewAllPropertyDetail
    {
        ...
        public string NormalInterest { get; set; }
        public string PenalInterest { get; set; }
        public string EnerestMoney { get; set; }
        public string AllotmentMoney { get; set; }
